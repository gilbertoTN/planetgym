class Partner < ActiveRecord::Base
  attr_accessible :address, :background, :birthday, :colony, :entry, :name, :observations, :phone, :sex, :email, :image, :uid,:provider, :link,:active,:publish
  validates :address, :background, :birthday, :colony, :entry, :name, :observations, :phone, :sex, :email, :image, :uid,:provider,:presence => true
